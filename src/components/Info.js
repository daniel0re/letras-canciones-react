...
const Info = ({ info }) => {
    ...
    const { strArtist, strArtistThumb, strGenre, strFacebook, strTwitter, strLastFMChart, strBiographyES } = info;
    ...
    return (
        <div className="card border-light">
            ...
            <div className="card-body">
                <img src={strArtistThumb} alt={`Logo ${strArtist}`} />
